...
class ResPartner(models.Model):
    ...
    customer_contact_type = fields.Selection([('architect', 'Architect'), 
        ('project_manager', 'Project Manager'),
        ('superintendent', 'Superintendent'),
        ('purchasing_manager', 'Purchasing Manager/AP'),
        ('sanitation_expert', 'Sanitation Expert'),
        ('maintenance_supervisor', 'Maintenance Supervisor'),
        ('plant_manager_engineer', 'Plant Manager/Engineer'),
        ('shipping_receiving_contact', 'Shipping/Receiving Contact')],
        string="Customer Contact Type", related="customer_industry")
    linkedin = fields.Char(string="LinkedIn")
    customer_po = fields.Char(string="Customer PO#", related="sale_order_ids.customer_reference")

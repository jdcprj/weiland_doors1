...
class StockMoveLine(models.Model):
    ...
    forecast_qty_1 = fields.Float(string="Forecast QTY", related="product_id.virtual_available")
    product_type = fields.Selection(
        [('consu', 'Consumable'), ('service', 'Service'),
        ('product', 'Storable Product')], string="Product Type",
        related="product_id.type")
    internal_reference_1 = fields.Char(string="Internal Reference1",
    ...
    so_job_name_1 = fields.Char(string="SO Job Name")
    detailed_opening_number = fields.Char(string="detailed opening #", related="move_id.delivery_opening_number")
